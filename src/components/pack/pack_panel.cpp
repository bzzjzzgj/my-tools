...
namespace MyTools
{
	...
	{
		m_packTreeListCtrl->AppendColumn(_("图标"), 10);
		m_packTreeListCtrl->AppendColumn(_("名称"), 200);
		m_packTreeListCtrl->AppendColumn(_("编码"), 200);

		wxTreeListItem root = m_packTreeListCtrl->AppendItem(m_packTreeListCtrl->GetRootItem(), "");
		m_packTreeListCtrl->SetItemText(root, 1, _("赤金交子"));
